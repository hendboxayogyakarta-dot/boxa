...
import { Home, MessageCircle, LayoutGrid, Info, ShoppingCart } from "lucide-react";
...
export function MobileBottomNav({ settings }: { settings: SiteSettings }) {
  ...
  return (
    <>
      ...
      <CartDrawer open={cartOpen} onClose={() => setCartOpen(false)} whatsappNumber={settings.whatsapp_number} />
    </>
  );
}
